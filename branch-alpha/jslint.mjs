...
// test_cause:
// [" 0x", "read_digits", "expected_digits_after_a", 3, "0x"]
...
// test_cause:
// ["/*jslint-disable*/", "read_line", "line_disable", 0, "(global)"]
...
// test_cause:
// [" 0 //jslint-quiet", "read_line", "directive_quiet", 0, "(global)"]
...
// test_cause:
// ["/*jslint-disable*/\n0", "read_line", "line_source", 0, "(global)"]
...
// test_cause:
// [" 0 ", "read_line", "unexpected_trailing_space", 3, null]
...
// test_cause:
// [" /**//**/", "token_create", "expected_space_a_b", 6, "(comment)"]
...
// test_cause:
// [" \"\\", "char_after_escape", "unclosed_string", 3, null]
...
// [" \"\\\\\"", "char_after_escape", "char_after", 0, "\\"]
// [" \"\\`\"", "char_after_escape", "char_after", 0, "`"]
// [" \"\\b\"", "char_after_escape", "char_after", 0, "b"]
// [" \"\\f\"", "char_after_escape", "char_after", 0, "f"]
// [" \"\\n\"", "char_after_escape", "char_after", 0, "n"]
// [" \"\\r\"", "char_after_escape", "char_after", 0, "r"]
// [" \"\\t\"", "char_after_escape", "char_after", 0, "t"]
...
// test_cause:
// [" \"\\u{123456}\"", "char_after_escape", "too_many_digits", 11, null]
...
// test_cause:
// [" \"\\u0\"", "char_after_escape", "expected_four_digits", 5, null]
...
// test_cause:
// [" \"\\0\"", "char_after_escape", "unexpected_a_before_b", 3, "0"]
...
// test_cause:
// [" /*/*", "lex_comment", "nested_comment", 4, null]
...
// test_cause:
// [" 0/*", "lex_comment", "unclosed_comment", 0, null]
...
// test_cause:
// [" //t0d0", "lex_comment", "todo_comment", 2, "(comment)"]
...
// test_cause:
// [" 0\n /*global aa*/", "lex_comment", "misplaced_directive_a", 2, "global"]
...
// test_cause:
// [" /*jslint undefined*/", "lex_comment", "bad_option_a", 2, "undefined"]
...
// test_cause:
// [" /*global aa:false*/", "lex_comment", "bad_option_a", 2, "aa:false"]
...
// test_cause:
// [" `", "lex_megastring", "unclosed_mega", 2, null]
...
// test_cause:
// [" 0a", "lex_number", "unexpected_a_after_b", 3, "0"]
...
// test_cause:
// [" aa=/./g", "lex_regexp", "regexp_flag", 0, "g"]
// [" aa=/./i", "lex_regexp", "regexp_flag", 0, "i"]
// [" aa=/./m", "lex_regexp", "regexp_flag", 0, "m"]
// [" aa=/./u", "lex_regexp", "regexp_flag", 0, "u"]
// [" aa=/./y", "lex_regexp", "regexp_flag", 0, "y"]
...
// test_cause:
// [" aa=/./gg", "lex_regexp", "unexpected_a", 9, "g"]
// [" aa=/./z", "lex_regexp", "unexpected_a", 8, "z"]
...
// test_cause:
// [" aa=/$^/;", "lex_regexp", "missing_m", 9, null]
...
// test_cause:
// [" case /./", "lex_slash_or_regexp", "unexpected_a", 7, "(regexp)"]
// [" delete /./", "lex_slash_or_regexp", "unexpected_a", 9, "(regexp)"]
// [" in /./", "lex_slash_or_regexp", "unexpected_a", 5, "(regexp)"]
// [" instanceof /./", "lex_slash_or_regexp", "unexpected_a", 13, "(regexp)"]
// [" new /./", "lex_slash_or_regexp", "unexpected_a", 6, "(regexp)"]
// [" typeof /./", "lex_slash_or_regexp", "unexpected_a", 9, "(regexp)"]
// [" void /./", "lex_slash_or_regexp", "unexpected_a", 7, "(regexp)"]
// [" yield /./", "lex_slash_or_regexp", "unexpected_a", 8, "(regexp)"]
...
// test_cause:
// [" !/./", "lex_slash_or_regexp", "wrap_regexp", 3, "(regexp)"]
// [" %/./", "lex_slash_or_regexp", "wrap_regexp", 3, "(regexp)"]
// [" &/./", "lex_slash_or_regexp", "wrap_regexp", 3, "(regexp)"]
// [" +/./", "lex_slash_or_regexp", "wrap_regexp", 3, "(regexp)"]
// [" -/./", "lex_slash_or_regexp", "wrap_regexp", 3, "(regexp)"]
// [" 0 * /./", "lex_slash_or_regexp", "wrap_regexp", 6, "(regexp)"]
// [" 0 / /./", "lex_slash_or_regexp", "wrap_regexp", 6, "(regexp)"]
// [" ;/./", "lex_slash_or_regexp", "wrap_regexp", 3, "(regexp)"]
// [" </./", "lex_slash_or_regexp", "wrap_regexp", 3, "(regexp)"]
// [" >/./", "lex_slash_or_regexp", "wrap_regexp", 3, "(regexp)"]
...
// test_cause:
// [" \"0", "lex_string", "unclosed_string", 3, null]
...
// test_cause:
// [" `${//}`", "lex_token", "unclosed_mega", 2, null]
...
// test_cause:
// [" let undefined", "enroll", "cause_code", 0, null]
...
// test_cause:
// [" let aa;let aa", "enroll", "cause_code", 0, null]
...
// test_cause:
// [" let ignore;function aa(ignore){}", "enroll", "cause_code", 0, null]
...
// test_cause:
// [" function aa(){try{aa();}catch(aa){aa();}}", "enroll", "cause_code", 0, null] //jslint-quiet
// [" function aa(){var aa;}", "enroll", "cause_code", 0, null]
...
// test_cause:
// [" do{}while()", "fnc", "cause_code", 0, null]
// [" if(){}", "fnc", "cause_code", 0, null]
// [" while(){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" if(\"aa\"){}", "condition", "unexpected_a", "the_value.id", "(string)"]
// [" if(0%0){}", "condition", "unexpected_a", "the_value.id", "%"]
// [" if(0&0){}", "condition", "unexpected_a", "the_value.id", "&"]
// [" if(0){}", "condition", "unexpected_a", "the_value.id", "(number)"]
// [" if(0*0){}", "condition", "unexpected_a", "the_value.id", "*"]
// [" if(0+0){}", "condition", "unexpected_a", "the_value.id", "+"]
// [" if(0-0){}", "condition", "unexpected_a", "the_value.id", "-"]
// [" if(0/0){}", "condition", "unexpected_a", "the_value.id", "/"]
...
// [" if(0^0){}", "condition", "unexpected_a", "the_value.id", "^"]
// [" if(0|0){}", "condition", "unexpected_a", "the_value.id", "|"]
// [" if(typeof 0){}", "condition", "unexpected_a", "the_value.id", "typeof"]
...
// test_cause:
// [" ;", "parse_statements", "statement_list", "token_nxt.id", "(end)"]
// [" case", "parse_statements", "statement_list", "token_nxt.id", "case"]
// [" default", "parse_statements", "statement_list", "token_nxt.id", "default"]
// [" else", "parse_statements", "statement_list", "token_nxt.id", "else"]
...
// test_cause:
// [" while(0){break;0;}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa(){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let aa={0:0}", "fnc", "cause_code", 0, null]
...
// [" aa._", "survey", "weird_property_a", "id", "_"]
// [" aa._aa", "survey", "weird_property_a", "id", "_aa"]
// [" aa.aaSync", "survey", "weird_property_a", "id", "aaSync"]
// [" aa.aa_", "survey", "weird_property_a", "id", "aa_"]
...
// test_cause:
// [" arguments", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" Function", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" isFinite", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" void", "fnc", "cause_code", 0, null]
// [" void 0", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa(aa=0,{}){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa(aa=0,{}){}", "fnc", "cause_code", 0, null]
// [" function aa({0}){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa({aa=aa},aa){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa({bb,aa}){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa(aa=0,bb){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" while(0){aa.map(function(){});}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" async function aa(){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" await", "fnc", "cause_code", 0, null]
// [" function aa(){aa=await 0;}", "fnc", "cause_code", 0, null]
// [" function aa(){await 0;}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" while(0){aa.map(()=>0);}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa={get aa(){}}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa={get aa(){},get aa(){}}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa={aa,aa}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa={get aa.aa}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa={bb,aa}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" ;{}", "fnc", "cause_code", 0, null]
// [" class aa{}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa:{function aa(aa){break aa;}}", "fnc", "cause_code", 0, null]

                    warn("out_of_scope_a");
                } else {

// test_cause:
// [" aa:{break aa;}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let aa;var aa", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" switch(0){case 0:var aa}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" const aa=0;const bb=0;", "fnc", "cause_code", 0, null]
// [" let aa=0;let bb=0;", "fnc", "cause_code", 0, null]
// [" var aa=0;var bb=0;", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" import aa from \"aa\";\nlet bb=0;", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" /*jslint beta*/\nconsole.log();let aa=0;", "fnc", "cause_code", 0, null]
// [" console.log();var aa=0;", "fnc", "cause_code", 0, null]
// [" try{aa();}catch(aa){var aa=0;}", "fnc", "cause_code", 0, null]
// [" while(0){var aa;}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" var{aa}=0", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let{bb,aa}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let ignore;function aa(ignore) {}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let 0", "fnc", "cause_code", 0, null]
// [" var{aa:{aa}}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let aa,bb;", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" /*jslint beta*/\nconst bb=0;const aa=0;", "fnc", "cause_code", 0, null]
// [" /*jslint beta*/\nlet bb;let aa;", "fnc", "cause_code", 0, null]
// [" /*jslint beta*/\nvar bb;var aa;", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" continue", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" debugger", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" delete 0", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa(){do{break;}while(0)}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" export {aa}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let aa;export{aa,aa}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" export default 0;export default 0", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" export default {}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" export default Object.freeze({})", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" export function aa(){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let aa;export{aa};export function aa(){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" export const", "fnc", "cause_code", 0, null]
// [" export let", "fnc", "cause_code", 0, null]
// [" export var", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" for(const aa in aa){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" for(0 in aa){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" for(aa;aa;aa++){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" if(0){0}else if(0){0}", "fnc", "cause_code", 0, null]
// [" if(0){0}else{0}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" if(0){break;}else{break;}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" if(0){break;}else{}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" /*global aa*/\nimport aa from \"aa\"", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" import ignore from \"aa\"", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa(){try{}finally{return;}}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa(){try{}finally{switch(0){}}}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" switch(0){case 0:break;case 0:break}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" switch(0){case 0:}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" switch(0){case 0:break;default:}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" switch(0){case 0:break;default:break;}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" try{throw 0}catch(){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" try{try{}catch(){}}catch(){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" try{}catch(){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" try{}finally{break;}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" function aa(){while(0){break;}}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" [false]", "fnc", "cause_code", 0, null]
// [" [null]", "fnc", "cause_code", 0, null]
// [" [true]", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" {\"aa\":0,\"aa\":0}", "fnc", "cause_code", 0, null]

                                warn("duplicate_a", token_now);
                            } else if (token_now.value === "__proto__") {

// test_cause:
// [" {\"__proto__\":0}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" [undefined]", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" if(0){import aa from \"aa\";}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa=function(){}", "fnc", "cause_code", 0, null]
...
// [" 0","walk_statement","unexpected_expression_a","thing.id", "(number)"]
// [" async function aa(){await 0;}","walk_statement","unexpected_expression_a","thing.id", "(number)"], //jslint-quiet
// [" typeof 0","walk_statement","unexpected_expression_a","thing.id", "typeof"]
...
// [" aa", "fnc", "cause_code", 0, null]
// [" class aa{}", "fnc", "cause_code", 0, null]
// [" let aa=0;try{aa();}catch(bb){bb();}bb();", "fnc", "cause_code", 0, null]
// [" let aa=0;try{aa();}catch(ignore){bb();}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa:while(0){aa;}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let aa;if(aa){let bb;}bb;", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" /*jslint getset*/\naa={set aa(){}}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" typeof 0===0", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" typeof aa===\"undefined\"", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" typeof 0===\"aa\"", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa in aa", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" 0 instanceof 0", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" const aa=0;for(aa in aa){}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" if(0){aa=0}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa.aa=undefined", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa+=undefined", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" if(0===0){0}", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa=window[0]", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa=self[0]", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa=RegExp.aa", "fnc", "cause_code", 0, null]
...
// [" aa=/./&&/./","file","weird_condition_a","te0.id", "(regexp)"]
// [" aa=0&&0","file","weird_condition_a","te0.id", "(number)"]
// [" aa=[]&&[]","file","weird_condition_a","te0.id", "["]
// [" aa=`${0}`&&`${0}`","file","weird_condition_a","te0.id", "`"]
...
// test_cause:
// [" new Boolean()","file","unexpected_a","left.id", "Boolean"]
// [" new Number()","file","unexpected_a","left.id", "Number"]
// [" new String()","file","unexpected_a","left.id", "String"]
// [" new Symbol()","file","unexpected_a","left.id", "Symbol"]
// [" new aa()","file","unexpected_a","left.id", "aa"]
...
// test_cause:
// [" new Function()", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" new Array()", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" new Object()", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" new Date.UTC()", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" let Aa=Aa.Aa()", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" new Date().getTime()", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa=RegExp[0]", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa?true:false", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" aa?false:true", "fnc", "cause_code", 0, null]
...
// test_cause:
// [" (aa&&!aa?0:1)", "fnc", "cause_code", 0, null]
...
// test_cause2:
// [" let aa=( 0);", "no_space_only", "unexpected_space_a_b", 11, "0"]
...
// test_cause2:
// [" let aa=0;", "expected_at", "expected_a_at_b_c", 2, 1]
...
// test_cause2:
// [" let {aa,bb}=0;", "one_space", "expected_space_a_b", 10, "bb"]
...
// test_cause2:
// [" /*global aa*/", "jslint", "missing_browser", 2, "(comment)"]
